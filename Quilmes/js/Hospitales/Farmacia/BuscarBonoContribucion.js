...
function List_BonoContribucion_Cargada(Resultado) {
    Bonos = Resultado.d;
    var Tabla_Datos = "";
    Tabla_Titulo = "<table id='TablaBonos' class='table table-hover table-condensed' style='width: 100%;'><thead><tr><th>Bono</th><th>Paciente</th><th>NHC</th><th>Fecha</th><th>Usuario</th></tr></thead><tbody>";
    $.each(Bonos, function (index, bono) {
        ...
        Tabla_Datos = Tabla_Datos + "><td>" + bono.Pedido_Id + "</td><td>" + bono.Nombre_Cliente + "</td><td>" + bono.NHC + "</td><td>" + fecha + "</td><td>" + bono.Usuario + "</td></tr>";
    });
