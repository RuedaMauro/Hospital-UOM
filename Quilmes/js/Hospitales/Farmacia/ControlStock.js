...
function List_ControlStock_Cargado(Resultado) {
    var Lista = Resultado.d;
    var Encabezado = "<table class='table table-hover table-condensed' style='width: 100%;'><thead><tr><th>Insumo</th><th>Presentación</th><th>Rubro</th><th>Stock Actual</th><th>Stock Mínimo</th><th>Stock Máximo</th></tr></thead><tbody>"; 
    var Contenido = "";
    $.each(Lista, function (index, Medicamento) {
        Contenido = Contenido + "<tr><td>" + Medicamento.Medicamento + " </td><td> " + Medicamento.Presentacion + " </td><td> " + Medicamento.Rubro + " </td><td> " + Medicamento.Stock + " </td><td> " + Medicamento.StockMin + " </td><td> " + Medicamento.StockMax + " </td></tr>";
    });
    var Pie = "</tbody></table>";
