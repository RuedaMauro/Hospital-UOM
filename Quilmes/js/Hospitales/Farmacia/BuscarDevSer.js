...
$("#btnCargar").click(function () {
    window.location = "DevolucionporServicio.aspx";
...
function Pedidos_Cargados(Resultado) {
    Pedidos = Resultado.d;
    var Tabla_Datos = "";
    Tabla_Titulo = "<table id='TablaPedidos_div' class='table table-hover table-condensed' style='width: 100%;'><thead><tr><th>Nro. Devolución</th><th>Fecha</th><th>Servicio</th><th>Usuario</th></tr></thead><tbody>";
    $.each(Pedidos, function (index, Pedido) {
        Tabla_Datos = Tabla_Datos + "<tr";
        Tabla_Datos = Tabla_Datos + " style='cursor:pointer' onclick=Ventana('DevolucionporServicio.aspx?Id=" + Pedido.Pedido_Id + "');";
