...
function ConCeros8(Cifras) {
 ...
 function List_Remitos_DetallebyId_Cargado(Resultado){
     ...
     var Encabezado = "<table class='table table-hover table-condensed' style='width: 100%;'><thead><tr><th></th><th>Insumo</th><th>Cantidad</th><th>Nro Lote</th><th>Compra (x unidad)</th><th>Venta (x unidad)</th><th>Vencimiento</th></tr></thead><tbody>";
     var Contenido = "";
     var i = 0;
...
function RenderizarTabla() {
    var Encabezado = "<table class='table table-hover table-condensed' style='width: 100%;'><thead><tr><th></th><th>Insumo</th><th>Cantidad de Unidades</th><th>Nro Lote</th><th>Compra (x unidad)</th><th>Venta (x unidad)</th><th>Vencimiento</th></tr></thead><tbody>";
    var Contenido = "";
    ...
    for (var i = 0; i <= Total; i++) {
        ...
        if (objMedicamentos[i].Estado == 1) {
            if (remitoId > 0) {
                Contenido = Contenido + "<tr><td><a id='Editar" + i + "' onclick='Editar(" + i + ");' class='btn btn-mini' title='Editar Medicamento'><i class='icon-edit'></i></a><a id='Elminar" + i + "'onclick='Eliminar(" + i + ");' style='display:none;' class='btn btn-mini btn-danger' rel='tooltip' title='Quitar Medicamento'><i class='icon-remove-circle icon-white'></i></a></td><td> " + objMedicamentos[i].Nombre + "(" + objMedicamentos[i].Insumo_Id + ") </td><td> " + objMedicamentos[i].Cantidad + " </td><td>" + objMedicamentos[i].NroLote + " </td><td> $ " + objMedicamentos[i].Precio_Compra + " </td><td> $ " + objMedicamentos[i].Precio_Venta + " </td><td>" + objMedicamentos[i].FechaVencimiento + " </td></tr>";
            }
            else
