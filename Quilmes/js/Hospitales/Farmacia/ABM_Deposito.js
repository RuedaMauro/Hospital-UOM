...
function List_Depositos_Cargado(Resultado) {
    ...
    $.each(Depositos, function (index, Deposito) {
        var Estado = "Inactivo";
        if (Deposito.Estado) Estado = "Activo";
        Tabla_Datos = Tabla_Datos + "<tr";
        Tabla_Datos = Tabla_Datos + ""
        Tabla_Datos = Tabla_Datos + "><td><a id='Editar" + index + "' onclick='Editar(" + index + ");' class='btn btn-mini' title='Editar'><i class='icon-edit'></i></a></td><td>" + Deposito.Deposito + "</td><td>" + Estado + "</td></tr>";
