...
function List_Partes() {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Facturacion/Facturacion.asmx/List_RendicionAmbulatoria_Monica_SN",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
$("#btnPrevia").click(function () {
    var url = "../Impresiones/ImpresionSeleccionDatos_Monica_Ambu_SN.aspx?Partes=" + objPartes + "&DesdeParte=" + $("#txtDesdeParte").val() + "&HastaParte=" + $("#txtHastaParte").val() + "&Tipo=" + $("#cbo_Tipo :selected").val() + "&Os=" + $("#cbo_Institucion :selected").val();
    Ventana(url);
});
