...
function Impresion(Resultado) {
    ...
    if (r > 0) {
            ...
            $.fancybox(
        {
            ...
            'href': '../Impresiones/Impresion_Endoscopia_ProtesisyOtros.aspx?Id=' + Id,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
    ...
    else { alert("Error al Guardar Extras!!"); }
    imprimir_comprobate = false;
}
...
function DeleteDetalles() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/Borrar_ProtesisyOtros",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: GuardarCab,
...
function GuardarCab(Resultado) {
    ...
    if (r > 0) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Endoscopia/Endoscopia.asmx/Guardar_Protesis_Cab",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function GuardarDetalles(Resultado) {
    ...
    //var json = JSON.stringify({ "p": objMedicamentos[j] });
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Endoscopia/Endoscopia.asmx/Guardar_Protesis_Det",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: Impresion,
...
function CargarProtesis() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/Protesis_CAB",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function CargarProtesisDetalle(Resultado) {
    ...
    $.each(Lista, function (index, p) {
        ...
        $.ajax({
            type: "POST",
            url: "../Json/Endoscopia/Endoscopia.asmx/Protesis_Lista_Det",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: CargarTabla,
...
$("#btn_edicion_aceptar").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/InsumoProtesis_AM_Insumos_Guardar",
        contentType: "application/json; charset=utf-8",
...
function CargarInsumos() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/InsumoProtesis_Insumos_Listar",
        contentType: "application/json; charset=utf-8",
        data: '{Insumo_ID: 0}',
        dataType: "json",
        success: function (Resultado) {
