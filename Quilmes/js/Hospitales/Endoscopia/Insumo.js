...
$(document).ready(function () {
    ...
    if (Tipo == 2) {
        parent.document.getElementById("DondeEstoy").innerHTML = "Endoscopía > Turnos > Planificar Endoscopía > <strong>INSUMOS</strong>";
        $("#btn_imprimir").show();
    }
    if (Tipo == 3) {
...
function LoadDatos() {    
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/ListaCirugias_Id",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Delete_Insumos() {
    var json = JSON.stringify({ "Cirugia_Id": Id, "Tipo": Tipo });
        $.ajax({
            type: "POST",
            url: "../Json/Endoscopia/Endoscopia.asmx/DeleteInsumosQuirurgicos",
            data: json,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function Delete_Insumos_Cargado(Resultado){      
    ...
    var json = JSON.stringify({ "Cirugia_Id": Id, "Insumos": objMedicamentos_guardados, "Tipo": Tipo  });            
            $.ajax({
                type: "POST",
                url: "../Json/Endoscopia/Endoscopia.asmx/InsertInsumosEndoscopia",
                data: json,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: Print,
...
function Print() {
    ...
    if (imprimir_comprobate && Tipo == 2) {
        ...
        $.fancybox(
        {
            ...
            'href': '../Impresiones/Endoscopia_Impresion_Insumo.aspx?CirugiaId=' + Id + "&Tipo=" + Tipo,
            'width': '95%',
            'height': '95%',
            'autoScale': false,
            'transitionIn': 'none',
...
//    $.ajax({
//        type: "POST",
//        url: "../Json/Endoscopia/Endoscopia.asmx/ListInsumosPlantilla_cargada_POS",
//        data: json,
//        contentType: "application/json; charset=utf-8",
//        dataType: "json",
...
function LoadPlantilla() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/Cargar_Plantilla_Cargado",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: LoadPlantilla_Cargado,
...
function List_Insumos(Nombre) {
    $.ajax({
        type: "POST",
        data: '{Insumo: "' + Nombre + '"}',
        url: "../Json/Endoscopia/Endoscopia.asmx/H2_ENDOSCOPIA_LISTAR_INSUMOS",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
