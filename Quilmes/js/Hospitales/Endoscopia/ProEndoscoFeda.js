...
function GuardarProtocolo() {    
    ...
    q.Esofago = $("#txt_Esofago").val();
    q.Estomago = $("#txt_Estomago").val();
    q.Duodeno = $("#txt_Duodeno").val();
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/Endoscopia_ProEndoscoFeda_Guardar",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Protocolo_Guardado(Resultado) {
    ...
    if (num > 0) {
            ...
            $.fancybox(
        {
            ...
            'href': '../Impresiones/Endoscopia_ProEndoscoFeda.aspx?Id=' + Id,
            'width': '75%',
            'height': '75%',
            'autoScale': false,
            'transitionIn': 'none',
...
function LoadProtocolo() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/CargarProEndoscoFeda_ByCirugiaId",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function LoadProtocolo_Cargada(Resultado) {
    var qui = Resultado.d;
    $("#txt_Esofago").val(qui.Esofago);
    $("#txt_Estomago").val(qui.Estomago);
    $("#txt_Duodeno").val(qui.Duodeno);
