function ChequearTodo() {
    ...
    var Pagina = "../Impresiones/Impresiones_IMG/IMG_Parte_Diario.aspx?MedicosId=" + objBusquedaListaMedico + "&EspecialidadesId=" + objBusquedaListaEspecialidad + "&desde=" + $("#txtFechaInicio").val() + "&hasta=" + $("#txtFechaFin").val();
