...
function Cargar_Turnos(MedicoId, EspecialidadId, FechaDesde, HoraDesde, Reservados, Libres, Dias, Sobreturnos, Cancelados) {
    $.ajax({
        ...
        data: '{MedicoId: "' + MedicoId + '", EspecialidadId: "' + EspecialidadId + '", sFechaDesde: "' + FechaDesde + '", HoraDesde: "' + '' + '", Reservados: "' + Reservados + '", Libres: "' + Libres + '", Dias: "' + Dias + '", Sobreturnos: "' + Sobreturnos + '", Cancelados: "' + Cancelados + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
    ...
    $.fancybox(
        {
            ...
            'enableEscapeButton': false,
            'onClosed': function () {
                document.location = "../Turnos_IMG/CargaExpress.aspx";
            }
        });
}
