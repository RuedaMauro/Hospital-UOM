function ChequearTodo() {
    ...
    //var Pagina = "../Impresiones/ImpresionTodoslosTurnos.aspx?MedicosId=0&EspecialidadesId=326,&FechaInicio=" + $("#txtFechaInicio").val() + "&FechaFin=" + $("#txtFechaFin").val() + "&Todos=" + Todos;
