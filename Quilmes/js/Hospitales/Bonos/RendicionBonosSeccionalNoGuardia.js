...
function Seccionales_Listas_Cargadas(Resultado) {
    ...
    $('#cboSeccional').append('<option value="9999">No Quilmes</option>');
...
$("#btn_BuscarRendicion").click(function () {
    Ruta = '../Impresiones/BonoResumenporSeccionalNoGuardia.aspx?Fi=' + $('#txtFechaInicio').val() + "&Ff=" + $("#txtFechaFinal").val() + "&Sl=" + $('#cboSeccional option:selected').val();
    $.fancybox(
		{
