...
public partial class Impresiones_ImpresionPracMod_SinConvenio : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[4] = new ReportParameter("Seccional", Request.QueryString["Seccional"]);
