<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Endoscopia_Impresion_Protocolo_CPER.aspx.cs" Inherits="Impresion_Endoscopia_Impresion_Protocolo_CPER" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Endoscopia_Impresion_Protocolo_CPER.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoTurno" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Endoscopia_Turno_ProtocoloCPERPrint" 
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoProtocolo" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Endoscopia_Protocolos_CPER_ListPrint" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
