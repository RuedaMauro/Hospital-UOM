        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:120px;">
             <form class="form-inline" style="margin:5px 25px 0px 25px;">
              <label for="stock_medicamento" style="display:none;">Stock Actual: </label><div id="stock_medicamento" style="display:none;"></div>
              <label for="precio_medicamento">Precio($): </label><input type="text" id="precio_medicamento" name="precio_medicamento" style="display:inline; width:60px; margin-top:5px;"/>
            </form>

              <form id="frm_Cantidad" class="form-inline" style="margin:10px 25px 0px 25px;">
                   <div id="controlcantidad" class="control-group" style="display:inline;"><label for="cantidad">Cantidad: </label>&nbsp;&nbsp;<input rel="tooltip" title="cantidad" type="text" id="cantidad" name="cantidad" value="1" class="input-mini" /></div>&nbsp;&nbsp;&nbsp;&nbsp;<input rel="tooltip" title="total por blister" type="text" id="cantidadx" value="1" style="display:none;" class="input-mini" />
