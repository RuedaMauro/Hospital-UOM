<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LaboratorioInternacion.aspx.cs" Inherits="Laboratorio_LaboratorioInternacion" %>
...
<body>
        ...
        <div class="contenedor_bono">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <a id="btnBuscarPaciente" href="../Turnos/BuscarPacientes.aspx?Desde=LI&?Express=0" class="btn"><i class="icon-search icon-black">
                        </i></a>
                    </div>
                </div>
          ...
          <input type="hidden" id="Cod_OS" />
              ...
              <select id="cbo_ObraSocial" style="display:none;"></select>          
                ...
                <div class="control-group">
                    <div class="controls pagination-centered"> 
                        <a class="btn btn-danger" href="LaboratorioInternacion.aspx" id="btnCancelarPedidoTurno" style="display: none;">
            ...
            <div id="hastaaqui">
                <div class="resumen_datos">
                 ...
                 <li class="active"><a href="#Bono" data-toggle="tab">Bono</a></li>
                 <li><a href="#DInt" data-toggle="tab">Internación</a></li>
  ...
  <div class="tab-pane active" id="Bono">
                <div class="contenedor_3" style="height:450px;">

                <div class="titulo_seccion">
                        <img src="../img/1.jpg" />&nbsp;&nbsp;<span>Bono</span></div>
                        ...
                        <div class="DatosPrincipalesLabo"><span class="span1">Nro. Bono</span>
                        <input id="txt_Bono" type="text" maxlength="8" class="span2">
                        <img id="BonoEstado" width="14" height="14"/>
                        </div>
  ...
  <div class="tab-pane" id="DInt">
                <div class="contenedor_3" style="height:450px;">
               
                
                    <div class="titulo_seccion">
                        <img src="../img/2.jpg" />&nbsp;&nbsp;<span>Internación</span></div>
                        ...
                        <div class="DatosPrincipalesLabo"><span class="span1">Servicio</span>
                            <select id="cbo_Servicio" class="span4">
                                <option value=""></option>
                            </select>
                        </div>


                        <div class="DatosPrincipalesLabo"><span class="span1">Sala</span>
                        <select id="cbo_Sala" class="span4">
                                <option value=""></option>
                            </select>
                        </div>

                        <div class="DatosPrincipalesLabo"><span class="span1">Cama</span>
                                <select id="cbo_Cama" class="span4">
                                <option value=""></option>
                            </select>
                        </div>
  ...
  <div class="tab-pane" id="DEst">
                ...
                <form runat="server">               
                    ...
                    <div class="titulo_seccion">
                        <img src="../img/3.jpg" />&nbsp;&nbsp;<span>Datos Estudios</span></div>
                        ...
                        <select id="cbo_tipoorden" style="width: 215px">
                                ...
                                <option value="D">Derivación</option>
                        </select>
                        </div>

                        <div class="DatosPrincipalesLabo" >Médico Solicitante
...
<%--                        <div class="DatosPrincipalesLabo">Fecha Perscripción
                        ...
                        <div class="DatosPrincipalesLabo" >Diagnostico
                            <asp:DropDownList ID="cbo_diagnostico1" runat="server" style="width: 215px" 
                                ...
                                <asp:ListItem Value="0">Sin Diagnóstico</asp:ListItem>
                            </asp:DropDownList>
                        ...
                        <div class="DatosPrincipalesLabo">Observación
  ...
  <div class="tab-pane" id="CEst">
                ...
                <div class="contenedor_3">
                    <div class="titulo_seccion">
                        <img src="../img/4.jpg" />&nbsp;&nbsp;<span>Cargar Estudios</span></div>
