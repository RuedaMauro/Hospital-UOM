...
public partial class Impresiones_Reportes_TurnosMedicos : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=TurnosPorMedico." + "PDF"));
