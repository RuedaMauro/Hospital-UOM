<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarOrdenesdeEstudios.aspx.cs" Inherits="AtConsultorio_BuscarOrdenesdeEstudios" %>
...
<body>
    ...
    <script>
        parent.document.getElementById("DondeEstoy").innerHTML = "Consultorio > <strong>Buscar Ordenes</strong>";
    </script>
        ...
        <div class="contenedor_1 pagination-centered" style="height:450px;">
            <div class="contenedor_a" style="height:400px;">
                <div class="titulo_seccion">
                    &nbsp;&nbsp;<span>Búsqueda de Ordenes de Estudio</span></div>
    ...
    <script src="../js/Hospitales/AtConsultorio/BuscarOrdEstudios.js" type="text/javascript"></script>
    <!--Barra sup-->
