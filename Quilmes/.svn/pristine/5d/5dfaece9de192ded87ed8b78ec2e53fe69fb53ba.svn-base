...
public partial class Impresiones_ImpresionRendicionIndInt_Medicos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("NroParte", Request.QueryString["Id"].ToString());
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=RendicionInternacionInd_Medicos." + "PDF"));
