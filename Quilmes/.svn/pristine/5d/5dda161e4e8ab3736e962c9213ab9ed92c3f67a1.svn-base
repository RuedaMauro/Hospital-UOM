<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProEndoscoVRSC.aspx.cs" Inherits="Endoscopia_ProEndoscoVRSC" %>
...
<script type="text/javascript" src="../js/bootstrap.js"></script> 
    <script src="../js/Hospitales/Endoscopia/ProEndoscoVRSC.js" type="text/javascript"></script>  
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Endoscopía > Turnos > Planificar Endoscopía > <strong>VRSC</strong>";
