...
var RoCanvas= function () {	
	...
	this.RO = function(id, vars) {		
		...
		if(self.toolbar.colors)
		{
			...
			toolBarHTML+='<div style="float:left;">Colores:</div>';
		...
		//	toolBarHTML += "&nbsp; Color Hexa:&nbsp;<a href=\"#\" class=\"roCanvasColorPicker\" style=\"background:white;\" onclick=\"RoCanvasInstances['"+self.id+"'].setColor(this.style.background);return false;\" id='customColorChoice"+ self.id +"'>&nbsp;</a> #<input type='text' size='6' maxlength='6' onkeyup=\"RoCanvasInstances['"+self.id+"'].customColor(this.value);\">";
		//}	
		...
		{
			toolBarHTML+='<div style="clear:both;">&nbsp;</div>';
			toolBarHTML += '<div style="float:left;">Tama&ntilde;o:</div>';
