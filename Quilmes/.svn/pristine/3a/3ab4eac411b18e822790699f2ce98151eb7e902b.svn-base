<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listados_Informes_Porcentaje_Ocupacional_Agrupado.aspx.cs" Inherits="Impresiones_Listados_Informes_Porcentaje_Ocupacional_Agrupado" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listados_Informes_Porcentaje_Ocupacional_Agrupado.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="H2_Listados_Porcentaje_Ocupacional" 
