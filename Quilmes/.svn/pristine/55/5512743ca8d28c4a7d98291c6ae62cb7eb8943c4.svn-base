<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionDiabeticaListados0.aspx.cs" Inherits="Impresiones_ImpresionDiabeticaListados" %>
...
<body>
    ...
    <div>
      <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionDiabeticaListados0.rdlc">
                <DataSources>
