<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quirofano_Protocolo.aspx.cs" Inherits="Impresion_Quirofano_Protocolo" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Quirofano_Protocolo.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoTurno" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Quirofano_Turno_ProtocoloPrint" 
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoProtocolo" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Quirofano_Protocolos_ListPrint" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
