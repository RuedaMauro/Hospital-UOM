...
function List_Diagnostico(Id, estado) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Endoscopia/Endoscopia.asmx/Diagnostico",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function List_Diagnostico_Post(Id, estado) {
    ...
    $.ajax({
        type: "POST",
        data: json,
        url: "../Json/Endoscopia/Endoscopia.asmx/Diagnostico_Post",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function GuardarProtocolo() {    
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/Endoscopia_ProEndoscoVRSC_Guardar",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function Protocolo_Guardado(Resultado) {
    ...
    if (num > 0) {
            ...
            $.fancybox(
        {
            ...
            'href': '../Impresiones/Endoscopia_ProEndoscoVRSC.aspx?Id=' + Id,
            'width': '75%',
            'height': '75%',
            'autoScale': false,
            'transitionIn': 'none',
    ...
    else alert("Error al Guardar VRSC!!");
}
...
function LoadProtocolo() {
    ...
    $.ajax({
        type: "POST",
        url: "../Json/Endoscopia/Endoscopia.asmx/CargarProEndoscoVRSC_ByCirugiaId",
        data: json,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
