<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Endoscopia_Impresion_Insumo.aspx.cs" Inherits="Impresion_Endoscopia_Impresion_Insumo" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Endoscopia_Impresion_Insumo.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Cabecera" runat="server" 
            ...
            SelectCommand="H2_ENDOSCOPIA_INSUMO_IMPRESION_CABECERA" 
        ...
        <asp:SqlDataSource ID="DetalleDAL" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_ENDOSCOPIA_INSUMOS_IMPRESION_DETALLE" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
