<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listados_Quirofano_Cirugias_Realizadas_Seccional.aspx.cs" Inherits="Impresiones_Listados_Quirofano_Cirugias_Realizadas_Seccional" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listados_Quirofano_Cirugias_Realizadas_Seccional.rdlc">
                <DataSources>
