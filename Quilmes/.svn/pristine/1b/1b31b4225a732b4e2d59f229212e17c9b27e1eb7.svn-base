<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionLiquidacionDetallado_Medicos.aspx.cs" Inherits="Impresiones_ImpresionLiquidacionDetallado_Medicos" %>
    ...
    <div>
      <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionLiquidacionDetallado_Medicos.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_FACT_LIQUIDACION_DETALLADO_MEDICOS" 
