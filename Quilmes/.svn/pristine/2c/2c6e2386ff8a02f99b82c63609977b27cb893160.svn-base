...
$("#btn_Buscar").click(function () {
    ...
    Pagina = "../Impresiones/InternacionListarporFechas.aspx?FInicio=" + FInicio + "&FFin=" + FFin + "&Seccionales=" + Seccionales + "&OS=" + OS + "&TodasSeccionales=" + TodasSeccionales + "&TodasOS=" + TodasOS;
