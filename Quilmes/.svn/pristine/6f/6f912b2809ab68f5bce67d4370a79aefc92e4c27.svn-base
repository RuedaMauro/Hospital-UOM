<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Impresion_HC_Movimientos.aspx.cs" Inherits="Impresiones_Impresion_HC_Movimientos" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Impresion_HC_Movimientos.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_HC_MOVIMIENTOS_PRINT" SelectCommandType="StoredProcedure">
            <SelectParameters>
