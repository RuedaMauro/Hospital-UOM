<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HistoricodeTurnosporPaciente.aspx.cs" Inherits="Turnos_HistoricodeTurnosporPaciente" %>
...
<script src="../js/Hospitales/Turnos/HistoricodeTurnosporPaciente.js" type="text/javascript"></script>
<!--Barra sup--> 
