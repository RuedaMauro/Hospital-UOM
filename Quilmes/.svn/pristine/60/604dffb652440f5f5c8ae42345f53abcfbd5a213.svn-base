<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PacientesLaboratorioBarras.aspx.cs" Inherits="Impresiones_ReportesCalo_PacientesLaboratorioBarras" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesCalo\PacientesLaboratorioBarras.rdlc">
                <DataSources>
