<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Impresion_ConstanciaEntrega.aspx.cs" Inherits="Impresiones_Compras_Impresion_ConstanciaEntrega" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Compras\Impresion_ConstanciaEntrega.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_COMPRAS_CONSTANCIA_ENTREGA_LIST" 
