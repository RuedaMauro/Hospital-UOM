...
public partial class Impresiones_ImpresionRendicionBono_porTerminal : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=RendiciondeBonos_porTerminal." + "PDF"));
