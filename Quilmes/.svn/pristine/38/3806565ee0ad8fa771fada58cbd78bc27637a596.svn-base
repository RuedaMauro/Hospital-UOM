        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:150px; margin-top:5px;">
              ...
              <div id="controltxtNHC" class="control-group" style="display:inline; margin:25px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNHC" name="txtNHC" placeholder="Ingrese NHC" class="input-medium" style="margin-top:10px;width:300px;" />
              </div>
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro de Pedido" class="input-medium" style="margin-top:10px;width:300px;" />
              </div>
