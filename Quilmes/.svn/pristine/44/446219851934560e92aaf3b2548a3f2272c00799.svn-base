<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listados_Informes_Consumo_De_Guardia.aspx.cs" Inherits="Impresiones_Listados_Informes_Consumo_De_Guardia" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listados_Informes_Consumo_De_Guardia.rdlc">
                <DataSources>
