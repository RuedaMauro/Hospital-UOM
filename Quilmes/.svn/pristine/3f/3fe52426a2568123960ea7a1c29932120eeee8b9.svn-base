<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listado_Diabetes_Tratamiento.aspx.cs" Inherits="Impresiones_ImpresionDiabeticaListados1" %>
  ...
  <form id="form1" runat="server">
    ...
    <div>
      <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listado_Diabetes_Tratamiento.rdlc">
                <DataSources>
           ...
           <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listado_Diabetes_Tratamiento" 
