...
<body>
    ...
    <script>
        parent.document.getElementById("DondeEstoy").innerHTML = "Turnos > <strong>Médicos</strong>";
    </script>
    ...
    <div class="container" style="padding-top: 30px; width:800px;">
        <div class="contenedor_1 pagination-centered" style="height:450px;">
            <div class="contenedor_a" style="height:410px;">
                <div class="titulo_seccion">
                    &nbsp;&nbsp;<span>Búsqueda de Recetas</span></div>
        ...
        <form class="form-inline" style="margin: 0px">                
                    ...
                    <div id="ControltxtAfiliado" class="input-prepend inline control-group " style="display:inline-block;">
                            ...
                            <input class="span4" maxlength="50" id="txtAfiliado" type="text" style="width:400px;">
                     </div>
         </form>               
         ...
         <div class="clearfix"></div>
                ...
                <div id="Resultado" class="tabla" style="height: 220px; width: 98%; margin-left: 1%">
