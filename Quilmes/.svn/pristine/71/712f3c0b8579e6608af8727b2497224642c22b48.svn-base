<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportesDeEndoscopia.aspx.cs" Inherits="Informes_Prueba" %>
...
<div class="aspNetHidden">
  ...
  <div class="contenedor_1">
    ...
    <div class="contenedor_a" style="position:relative; colmargin-left:15px;height:530px; margin-left:14px">
        <h3 id="titulo_prev">Reportes de Endoscopia</h3>        
        <div id="opciones" style="margin-left:15px; height:467px; overflow:scroll">
            <a href="FiltrarListadosEndoscopia.aspx?titulo=Endoscopias Realizadas&tipo=1" ><div class=" icon-th-list"></div> Endoscopias Realizadas_</a><br />
            <a href="FiltrarListadosEndoscopia.aspx?titulo=Ranking de Procedimientos&tipo=2" ><div class=" icon-th-list"></div> Ranking de Procedimientos_</a><br />
        </div>
