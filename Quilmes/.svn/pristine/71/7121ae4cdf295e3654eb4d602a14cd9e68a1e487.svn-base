...
public partial class Impresiones_Compras_Compras_ImpresionEntrega100 : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Impresion_Remito_100." + "PDF"));
