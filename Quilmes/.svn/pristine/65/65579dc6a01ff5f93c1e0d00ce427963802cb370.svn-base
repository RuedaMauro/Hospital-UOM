<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RendicionAmbulatoriaSN.aspx.cs" Inherits="Facturacion_RendicionAmbulatoriaSN" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:490px;"> <div class="titulo_seccion" id="titulo_bono" style="display:none;">
      <span>Rendición de Prestaciones Ambulatoria</span></div>
      <form id="frm_Main" name="frm_Main">
        ...
        <div class="row">
               <div id="controltxtDesdeParte" class="span5">
                    ...
                    <input type="text" id="txtDesdeParte" name="txtDesdeParte" class="input-mini date" style="margin-top:10px; width:90px; margin-left:20px"/>
              </div>
            <div id="controltxtHastaParte" class="span5">
                   <label for="txtHastaParte" style="display:inline; margin-top:10px;">Fecha Hasta: </label>
                    <input type="text" id="txtHastaParte" name="txtHastaParte" class="input-mini date" style="margin-top:10px;width:90px; margin-left:20px"/>
              </div>
        </div>
        <div class="row">
        ...
        <div style="padding:15px 15px 0px 15px;">
            ...
            <div class="clearfix"></div>
            <div id="TablaPartes_div" class="tabla" style="height:250px;width:100%; margin-top:-70px; overflow:auto;">
              ...
              <table id="tabla" class="table table-hover table-condensed">
                <thead>					
                  <tr>    
                    ...
                    <th>Cantidad</th>
                    <th>Prestación</th>
                    <th style="display:none;">Hono OS</th>
                    <th>Gasto OS</th>
                    <th>Gasto Total</th>
                  </tr>
                  <tbody id="trx"></tbody>
...
<div class="pie_gris">
    <div class="pull-right">
        ...
        <button id = "btnPrevia" style="display:none;" class="btn btn-info"><i class=" icon-print icon-white"></i>&nbsp;Vista Previa</button>
    </div>
</div>
      </div>
    </div>
...
<script src="../js/jquery-ui-1.9.2.custom.js" type="text/javascript"></script>
    ...
    <script src="../js/Hospitales/Facturacion/RendicionAmbulatoriaSN.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Rendición de Prestaciones Ambulatoria</strong>";
