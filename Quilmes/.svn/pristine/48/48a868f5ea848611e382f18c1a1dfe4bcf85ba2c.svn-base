<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRendicionIndInt_Cap.aspx.cs" Inherits="Impresiones_ImpresionRendicionIndInt_Cap" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
                ...
                <LocalReport ReportPath="Impresiones\ImpresionRendicionIndInt_Cap.rdlc">
                    <DataSources>
                        ...
                        <rsweb:ReportDataSource DataSourceId="FuenteDatosCab" Name="DataSet3" />
                    </DataSources>
                </LocalReport>
            </rsweb:ReportViewer>
            ...
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_PARTE_PRINT_BYID" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="NroParte" QueryStringField="Id" Type="Int64" />
                </SelectParameters>
