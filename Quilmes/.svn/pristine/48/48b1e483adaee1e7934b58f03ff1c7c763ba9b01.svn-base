<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_ImpresionEntrega.aspx.cs" Inherits="Impresiones_Compras_Compras_ImpresionEntrega" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Compras\Compras_ImpresionEntrega.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_COMPRAS_IMPRESION_REMITO_DET_NO_100" 
