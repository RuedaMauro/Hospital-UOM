<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listado_Internacion_Porcentaje_Ocupacional_Agrupado.aspx.cs" Inherits="Impresiones_ReportesInternacion_Listado_Internacion_Porcentaje_Ocupacional_Agrupado" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesInternacion\Listado_Internacion_Porcentaje_Ocupacional_Agrupado.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listado_Internacion_Porcentaje_Ocupacional_Agrupado" 
