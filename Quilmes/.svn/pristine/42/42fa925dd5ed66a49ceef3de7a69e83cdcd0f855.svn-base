<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionHistoricoTurnosporPaciente.aspx.cs" Inherits="Impresiones_ImpresionHistoricoTurnosporPaciente" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionHistoricoTurnosporPaciente.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_Turnos_VerTodos_por_Paciente_Historico" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DbType="Date" DefaultValue="" Name="Hasta" 
                    QueryStringField="Hasta" />
                <asp:QueryStringParameter DefaultValue="" Name="EspId" QueryStringField="EspId" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
