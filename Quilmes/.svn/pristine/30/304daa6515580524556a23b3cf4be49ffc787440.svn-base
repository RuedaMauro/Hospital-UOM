<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Endoscopia_Resumen_Endoscopia.aspx.cs" Inherits="Impresiones_Endoscopia_Resumen_Endoscopia" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Endoscopia_Resumen_Endoscopia.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDetalle" runat="server" 
            ...
            SelectCommand="H2_Endoscopia_impresion_Resumen_items_totales" 
        ...
        <asp:SqlDataSource ID="FuenteCabecera" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Endoscopia_impresion_Resumen" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
