<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraCON_ENTRE_PISO.aspx.cs" Inherits="Turnera_TurneraCON_ENTRE_PISO" %>
...
<script src="../js/Hospitales/Llamador/TurneraCON_ENTRE_PISO.js" type="text/javascript"></script>
...
<script>
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraCON_ENTRE_PISO.aspx';
            }
        }
    }
