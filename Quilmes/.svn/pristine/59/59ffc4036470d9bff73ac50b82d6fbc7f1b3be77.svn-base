<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IMG_Carga_Resultados.aspx.cs" Inherits="Imagenes_IMG_Carga_Resultados" %>
    ...
    <div class="contenedor_2"> <div class="titulo_seccion">
      ...
      <div class="control-group">
          <div class="controls pagination-centered"> 
                <a class="btn btn-danger" href="IMG_Carga_Resultados.aspx" id="btnCancelarPedidoTurno" style="display:none;">Otro Paciente</a> 
                <a class="btn" id="btnactualizar" style="display:none;">Actualizar</a> 
                <a id="btn_Cargar" class="btn btn-info" >Cargar Resultado</a> 
...
<script src="../js/Hospitales/Imagenes/IMG_Cargar_Resultados.js" type="text/javascript"></script>
<script src="../js/General.js" type="text/javascript"></script>

<!--Barra sup--> 
<script type="text/javascript">
    //parent.document.getElementById("DondeEstoy").innerHTML = "Imágenes > <strong>Carga de resultados</strong>";
</script> 
