<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BarraBonos.aspx.cs" Inherits="Impresiones_ReportesCalo_BarraBonos" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesCalo\BarraBonos.rdlc">
                <DataSources>
