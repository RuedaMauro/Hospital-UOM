<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProtesisyOtros.aspx.cs" Inherits="Impresion_ProtesisyOtros" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Protesisyotros.rdlc" EnableExternalImages="true">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteProtesis" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Quirofano_ProtesisyOtros_Lista_Det" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
