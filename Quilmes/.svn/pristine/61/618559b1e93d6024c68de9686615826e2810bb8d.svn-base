<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Endoscopia_ProEndoscoFCC.aspx.cs" Inherits="Impresion_Endoscopia_ProEndoscoFCC" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Endoscopia_ProEndoscoFCC.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoProtocolo" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Endoscopia_ProEndoscoFCC_Listar_Imprimir" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
