<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraGuardiaPed.aspx.cs" Inherits="Turnera_TurneraGuardiaPed" %>
...
<script src="../js/Hospitales/Llamador/TurneraGuardiaPed.js" type="text/javascript"></script>
...
<script>
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraGuardiaPed.aspx';
            }
        }
    }
