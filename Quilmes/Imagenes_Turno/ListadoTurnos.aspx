    ...
    <div id="DatoTurno" style="display:snone;">
        <div id="Contenedor" class="well">                        
            ...
            <div class="Contenedor_Info_Medico">                
                ...
                Desde: <input type="text" id="txt_desde" style="width:80px;" />
                <span style="margin-left:19px;">Hasta:</span> <input type="text" id="txt_hasta" style="width:80px;" /><br />     
...
<script>
    ...
    function CargarTurnos(Objeto, SoloTurnos, Inicio, Fin, Especialidad, Medico, Tipo, HNC, Paciente, Documento) {
    ...
    function ActualizarListadoPacientes() {
        ...
        if ($("#cbo_medico").val() != "0") {
            ...
            CargarTurnos("tbody_turnos_dia", false, $("#txt_desde").val(), $("#txt_hasta").val(), $("#cbo_especialidad").val(), $("#cbo_medico").val(), $("#cbo_tipoorden").val(), $("#txt_nhc").val(), $("#txt_paciente").val(), $("#txt_documento").val());
...
//    }, 60000);
    ...
    $("#btn_imprimir").click(function () {
        ...
        var pagina = "../Impresiones/Impresiones_IMG/IMG_Impresion_ListadoTurnos.aspx?E=" + E + "&M=" + M + "&DI=" + DI + "&DF=" + DF + "&TO=" + TO + "&NHC=" + NHC + "&P=" + P + "&D=" + D;
