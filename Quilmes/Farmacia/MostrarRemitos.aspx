...
<div class="container" style="padding-top:30px; width:1000px;">
  <div class="contenedor_1" style="width:1000px;">
   <div class="contenedor_3" style="height:500px;width:970px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Remitos</span></div>
      <form id="frm_Main" name="frm_Main">
          <div class="contenedor_4 pagination-centered" style="height:110px;">
               
               <div id="controltxtLetra" class="control-group" style="display:inline; margin:10px 10px 0px 10px"><label for="txtLetra" style="display:inline;">Letra: </label><input type="text" id="txtLetra" maxlength="1" name="txtLetra" class="input-mini" style="margin-top:10px; margin-left:27px; width:40px" /></div><br />
                
              <%-- <div id="controltxtSucursal" class="control-group" style="display:inline; margin:10px 10px 0px 10px;"><input type="text" id="txtSucursal" maxlength="4" name="txtSucursal" class="input-mini" style="margin-top:10px"></div><br />--%>
                <div id="controltxtNumero" class="control-group" style="display:inline; margin:10px 10px 0px 10px;"><label for="txtNumero" style="display:inline;">Numero: </label>
                 <div id="controltxtSucursal" class="control-group" style="display:inline; margin:10px 10px 0px 10px;"><input type="text" id="txtSucursal" maxlength="4" name="txtSucursal" class="input-mini" style="margin-top:10px; width:40px">
                 <input type="text" id="txtNumero" maxlength="8" name="txtNumero" class="input-small" style="margin-top:10px; width:66px" /></div></div> 
          </div>
