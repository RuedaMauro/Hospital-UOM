<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RendicionBonoContribucion.aspx.cs" Inherits="Farmacia_RendicionBonoContribucion" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Rendición Bono Contribución</span></div>
      <form id="frm_Main" name="frm_Main">
          ...
          <div class="contenedor_4 pagination-centered" style="height:110px;">
               ...
               <div id="controlcbo_Usuarios" class="control-group" style="display:inline;">
                
                    <div class="combos" style="margin-left:10px;">
                    <label for="cbo_Usuarios" style="display:inline;">Usuarios: </label>
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaRendicion_div" class="tabla" style="height:342px;width:100%;">
...
<div class="pie_gris">
    <div class="pull-left" style="padding:5px; height:90px;">
        <label for="Total" style="display:inline; font-size:medium; font-weight:bold;">Rendición Total $</label><div id="Total" style="display:inline; font-size:medium; font-weight:bold;"></div>
    </div>
...
<script src="../js/Hospitales/Farmacia/RendicionBonoContribucion.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Rendición Bono Contribución</strong>";
