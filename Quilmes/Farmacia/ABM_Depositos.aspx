...
<body>
    ...
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Administración > <strong>Altas y Edición de Depósitos</strong>";
            ...
            <div id="hastaaqui" style="display: inline;">
                <div class="contenedor_3" style="height:460px;">
                    <div class="titulo_seccion">
                        <img src="../img/1.jpg" />&nbsp;&nbsp;<span>Altas y Edición de Depósitos</span></div>
                    ...
                    <form id="frm_Main">
                        ...
                        <div class="row">
                            <div class="span10">
                                ...
                                <span class="span1" style="width:100px;"><label for="txtDeposito" style="display:inline;">Depósito: </label></span>
                                    <input id="txtDeposito" name="txtDeposito" type="text" class="input-xlarge" rel='Ingrese Depósito'>
                                </div>
                            </div>
                         </div>   
