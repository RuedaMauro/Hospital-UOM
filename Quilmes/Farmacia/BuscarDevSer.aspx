        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:100px;">
              ...
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro Devolucion" class="input-medium" style="margin-top:10px; width:205px" />
              </div>
               <div id="controlcbo_Servicio" class="control-group" style="margin-left:25px;">
                    <label for="cbo_Servicio" style="display:inline; margin-top:10px;">Servicio: </label>
                    <select id="cbo_Servicio" style="width:220px; margin-left:70px;">
                    <option id=""></option>
                    </select>
              </div>
          ...
          <div class="contenedor_4 pagination-centered" style="height:100px;">
               ...
               <div id="controldesde" class="control-group" style="margin-left:20px;">
               <label for="desde" style="display:inline;">Desde: </label><input type="text" id="desde" name="desde" class="input-small" style="margin-top:10px;" />
               </div>
               <div id="controlhasta" class="control-group" style=" margin-top:-20px;margin-left:20px;">
               <label for="hasta" style="display:inline;">Hasta: </label>
               <input type="text" id="hasta" name="hasta" class="input-small" style="margin-top:10px; margin-left:5px" />
               </div>
