<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarPPS.aspx.cs" Inherits="Farmacia_BuscarPPS" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Pedidos por Servicio</span></div>
      <form id="frm_Main" name="frm_Main">
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:120px;">
              ...
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro de Pedido" class="input-medium" style="margin-top:10px;" />
              </div>
          ...
          <div class="minicontenedor100">
              <input id="cbo_Todos_Especialidades" type="checkbox" checked style="display:inline; margin:5px;"/>Marcar todos
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaPedidos_div" class="tabla" style="height:175px;width:100%; margin-top:-10px;">
...
<script src="../js/Hospitales/Farmacia/BuscarPPS.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong> Pedidos por Servicio > Buscar Pedidos por Servicio</strong>";
