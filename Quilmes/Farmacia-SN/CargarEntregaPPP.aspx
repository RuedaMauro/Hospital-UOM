...
<div class="container" style="padding-top:30px;">
  ...
  <div id="cargando2" style="text-align:center; display:none;">
    ...
    <div id="hastaaqui">
      ...
      <div class="contenedor_3" style="height:370px;"> <div class="titulo_seccion" id="titulo_bono">
      <img src="../img/2.jpg"/>&nbsp;&nbsp;<span>Datos de la Entrega</span></div>
        ...
        <div class="">
          <div class="contenedor_4 pagination-centered" style="height:110px;">
            ...
            <div id="controlcbo_Medicamento" class="control-group" style="display:inline; margin-top:10px;margin-left:10px;">
                  ...
                  <select id="cbo_Medicamento" style="width:300px;margin-top:10px;margin-left:10px;">
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaMedicamentos" class="tabla" style="height:162px;width:100%;">
...
<div class="pie_gris">
<div class="pull-right" style="padding:5px; height:100px;">
  <a href="EntregasPPP.aspx" class="btn"><i class=" icon-arrow-left"></i>&nbsp;Volver</a>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Entregas por Paciente</strong>";
