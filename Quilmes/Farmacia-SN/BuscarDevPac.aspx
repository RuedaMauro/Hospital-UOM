        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:150px; margin-top:5px;">
              ...
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro de Devolución" class="input-medium" style="margin-top:10px;" />
              </div>
               <div id="controltxtNombre" class="control-group" style="margin:0px 25px 25px 25px;">
                    ...
                    <input type="text" id="txtNombre" name="txtNombre" placeholder="Ingrese Nombre" class="input-medium" style="margin-top:10px;" />
              </div>
