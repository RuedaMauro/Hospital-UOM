<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarPPP.aspx.cs" Inherits="Farmacia_BuscarPPP" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Pedidos por Paciente</span></div>
      <form id="frm_Main" name="frm_Main">
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:150px; margin-top:5px;">
              ...
              <div id="controltxtNHC" class="control-group" style="display:inline; margin:25px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNHC" name="txtNHC" placeholder="Ingrese NHC" class="input-medium" style="margin-top:10px;width:250px;" />
              </div>
              <div id="controltxtNroPed" class="control-group" style="margin:0px 25px 0px 25px;">
                    ...
                    <input type="text" id="txtNroPed" name="txtNroPed" placeholder="Ingrese Nro de Pedido" class="input-medium" style="margin-top:10px;width:250px;" />
              </div>
          ...
          <input id="chk_Ninguno" type="checkbox" style="display:inline; margin:5px;"/>Desmarcar todos
                    <div class="filtro_datos" style="width:100%;">
        ...
        <div style="padding:0px 15px 0px 15px;">
            ...
            <div id="TablaPedidos_div" class="tabla" style="height:155px;width:100%; margin-top:-10px;">
...
<script src="../js/Hospitales/Farmacia/BuscarPPP.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong> Pedidos por Paciente > Buscar Pedidos por Paciente</strong>";
