...
<body>
    ...
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Farmacia > <strong>Altas y Edición de Proveedores</strong>";
                        ...
                        <div class="row">
                            <div class="span10">
                                ...
                                <span class="span1" style="width:100px;"><label for="txtProveedor" style="display:inline;">Proveedor: </label></span>
                                    <input id="txtProveedor" name="txtProveedor" type="text" class="input-xlarge" rel='Ingrese Proveedor'>
                                </div>
                            </div>
                         </div>   
                         <div class="row">
                                <div class="span4">
                                    <div id="controltxtTelefono" class="control-group">
                                     <span class="span1" style="width:100px;"><label for="txtTelefono" style="display:inline;">Telefono: </label></span>
                                        <input id="txtTelefono" name="txtTelefono" type="text" class="input-medium" rel='Ingrese Telefono'>
                                    </div>
                                </div>
                        </div>
                        <div class="row">
                                <div class="span5">
                                    ...
                                    <span class="span1" style="width:100px;"><label for="txtDireccion" style="display:inline;">Direccion: </label></span>
                                        <input id="txtDireccion" name="txtDireccion" type="text" class="input-large" rel='Ingrese Direccion'>
                                    </div>
                                </div>
                                    <div class="span4">
