...
/// <summary>
/// Descripción breve de Documentacion
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// Para permitir que se llame a este servicio Web desde un script, usando ASP.NET AJAX, quite la marca de comentario de la línea siguiente. 
[System.Web.Script.Services.ScriptService]
public class Documentacion_IMG : System.Web.Services.WebService
{

    public Documentacion_IMG () {
    ...
    {
        Hospital.DocumentacionBLL doc = new Hospital.DocumentacionBLL();
        return doc.Documentacion_Archivos_Ordenes_Medica(IdPaciente);
    }
