<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProEndoscoFCC.aspx.cs" Inherits="Endoscopia_f_ProEndoscoFCC" %>
  ...
  <div class="contenedor_1">
    ...
    <div id="hastaaqui">
      ...
      <div class="contenedor_3" style="height:460px;"> 
               ...
               <div style="background-color:White;height: 428px;position: absolute;width: 900px; padding-left:10px;display:none;" id="div_dibujo2">                
              ...
              <br /><div>Inspección</div>
              <textarea id="txt_Insepeccion" class="input-xxlarge" rows="2" style="width:880px;height: 32px;"></textarea>

              <br /><div>Videocolonoscopía</div>
              <textarea id="txt_fibrocolonoscopia" class="input-xxlarge" rows="2" style="width:880px;height: 76px;"></textarea>

              <br /><div>Impresión diagnóstica</div>
              <textarea id="txt_impresion_diagnostica" class="input-xxlarge" rows="2"  style="width:880px;height: 39px;"></textarea>
...
<script type="text/javascript" src="../js/bootstrap.js"></script> 
    <script src="../js/Hospitales/Endoscopia/ProEndoscoFCC.js" type="text/javascript"></script>  
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Endoscopía > Turnos > Planificar Endoscopía > <strong>VCC</strong>";
