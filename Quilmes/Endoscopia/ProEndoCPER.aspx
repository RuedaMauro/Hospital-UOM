<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProEndoCPER.aspx.cs" Inherits="Endoscopia_ProEndoCPER" %>
  ...
  <div class="contenedor_1">
    ...
    <div id="hastaaqui">
      ...
      <div class="contenedor_3" style="height:460px;"> 
              ...
              <div><span class="TitulosDatos">Anestesista: </span><span id="Span_Anestesista" class="Fila1"></span><span class="TitulosDatos" style="width:100px;">Asistente: </span><span id="Span_Instrument"></span></div>
              <div><span class="TitulosDatos" style="width:179px;">Diagnóstico Preoperatorio:</span> <span id="span_diagnostico_preoperatorio" style="width:600px; display:inline-block;" ></span> </div>
              
              <div><span class="TitulosDatos">Procedimiento: </span><span id="span_cirugia" style="display:inline-block; width:700px;"></span></div>

              <br /><div>Descripción</div>
              <textarea id="txt_esquema_operatorio" class="input-xxlarge" rows="2" style="width:880px; height:108px;" maxlength="4000"></textarea>
                            
              

              <br />              
              <label for="txt_cbo_Diagnostico" style="display:inline; margin-right: 10px;">Diagnóstico</label><br />
              <input type="text" readonly="readonly" id="txt_cbo_Diagnostico" style="width:791px;margin-bottom: 0px;"/>
              <div id="div_diagnostico" style="display:none;width: 806px; height:200px; background-color:#969696;margin-top: 0px;position:absolute; margin-left:0px;">
...
<div class="pull-right" style="padding:5px; height:120px;">
  ...
  <a id = "btnGuardar" class="btn btn-info" style="display:none;" ><i class=" icon-ok icon-white"></i>&nbsp;Guardar</a>
  <a id = "btn_imprimir" class="btn btn-info" ><i class=" icon-ok icon-white"></i>&nbsp;Guardar e Imprimir</a>
</div>
</div>
      </div>
    </div>
...
<script type="text/javascript" src="../js/bootstrap.js"></script> 
    <script src="../js/Hospitales/Endoscopia/ProEndoCPER.js" type="text/javascript"></script>  
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Endoscopía > Turnos > Planificar Endoscopía > <strong>CPER</strong>";
