<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarporFechas.aspx.cs" Inherits="Internacion_ListarporFechas" %>
...
<body>
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Admisión > <strong>Listado de Pacientes Internados</strong>";
     
    </script>
<div class="container">
  <div class="contenedor_1">
    <div class="contenedor_a" style="position:relative;margin-left:15px;height:500px">
      <h3>Listado de Pacientes Internados</h3>
      <div style="padding:15px;">

      <div>
      <input type="text" id="txt_Desde" class="span2" style="display:none"/>
      Fecha: <input type="text" id="txt_Hasta" class="span2" />
...
<script src="../js/Hospitales/Internacion/ListarporFechas.js" type="text/javascript"></script>
