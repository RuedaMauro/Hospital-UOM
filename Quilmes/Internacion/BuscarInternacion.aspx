<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarInternacion.aspx.cs"
    Inherits="Internacion_BuscarInternacion" %>
...
<body>
    ...
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Admisión > <strong>Buscar Internados</strong>";
            ...
            <div id="hastaaqui" style="display: inline; height:550px;">
                <div class="contenedor_3" style="height:500px;">
                    <div class="titulo_seccion">
                        <img src="../img/1.jpg" />&nbsp;&nbsp;<span>Buscar Internados</span></div>
                    <div class="">
                        <div class="minicontenedor50" style="display:none;">
                            <div class="controls">
                        ...
                        <div class="minicontenedor50">
                            <div class="controls">
                                ...
                                <span for="txtFechaFin" style="margin-left:0px">Fecha</span>
                            ...
                            <div class="controls">
                                ...
                                <a style="vertical-align:top; margin-left:21px" id="btn_Buscar" class="btn"><i class="icon-search"></i>Buscar</a>
                            </div>
                        </div>
                        <div class="clearfix">
                        </div>
...
<%--                        <form class="form-horizontal" style="margin-bottom: 5px; float: left;">--%>
                        ...
                        <div id="TablaInternaciones" class="tabla" style="height: 260px; width: 890px;">
...
<script src="../js/Hospitales/Internacion/BuscarInternacion.js" type="text/javascript"></script>
</body>
</html>
