<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarInternacion_Ambulatoria_SN.aspx.cs" Inherits="Internacion_BuscarInternacion_Ambulatoria_SN" %>
...
<body>
    ...
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Admisión > <strong>Buscar Internados (Ambulatorio)</strong>";
            ...
            <div id="hastaaqui" style="display: inline; height:550px;">
                <div class="contenedor_3" style="height:500px;">
                    <div class="titulo_seccion">
                        <img src="../img/1.jpg" />&nbsp;&nbsp;<span>Buscar Internados (Ambulatorio)</span></div>
                    <div class="">
                        ...
                        <div class="minicontenedor50">
                            ...
                            <div class="controls">
                                ...
                                <a style="vertical-align:top" id="btn_Buscar" class="btn"><i class="icon-search"></i>Buscar</a>
                            </div>
                        </div>
                        <div class="clearfix">
                        </div>
...
<%--                        </form>--%>
    ...
    <script src="../js/Hospitales/Internacion/BuscarInternacion_Ambulatoria_SN.js" type="text/javascript"></script>
</body>
</html>
