<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListarporFechas_Egresos.aspx.cs" Inherits="Internacion_ListarporFechas_Egresos" %>
...
<body>
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Admisión > <strong>Listado de Pacientes Egresados</strong>";
     
    </script>
<div class="container">
  <div class="contenedor_1">
    <div class="contenedor_a" style="position:relative;margin-left:15px;height:500px">
      <h3>Listado de Pacientes Egresados</h3>
...
<link href="../css/jquery.fancybox-1.3.4.css" rel="stylesheet" type="text/css" />
    ...
    <script src="../js/Hospitales/Internacion/ListarporFechas_Egresos.js" type="text/javascript"></script>
