<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CargaInsumos_borrar.aspx.cs" Inherits="Quirofano_CargaInsumos_borrar" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
    ...
    <div id="hastaaqui">
      ...
      <img src="../img/2.jpg"/>&nbsp;&nbsp;<span>Carga de Insumos Quirúrgicos</span></div>
        ...
        <div class="">
          ...
          <div class="contenedor_4 pagination-centered" style="height:120px;">
              <form id="frm_Cantidad" class="form-inline" style="margin:10px 25px 0px 25px;">
               ...
               <div id="controlObservacion" class="control-group" style="display:inline;"><label for="Observacion" style="display:inline;">Observacion: </label><input type="text" id="Observacion" name="Observacion" class="input-large" /></div>
...
<div class="pull-right" style="padding:5px; height:120px;">
  ...
  <button id = "btnOtros" class="btn btn-info"><i class=" icon-book icon-white"></i>&nbsp;Otros</button>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">Agregar Otros Comentarios</h3>
  </div>
  <div class="modal-body" style="margin-left:120px; margin-right:10px;">
  <div style="margin-left:40px;">
  <textarea id="Otros" placeholder="Ingrese Comentarios" rows="2" cols="10" style="width:350px;"></textarea><br />
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Quirófano > <strong>Carga de Insumos</strong>";
