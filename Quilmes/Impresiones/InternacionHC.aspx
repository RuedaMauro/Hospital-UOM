<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InternacionHC.aspx.cs" Inherits="Impresiones_InternacionHC" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\InternacionHC.rdlc">
                <DataSources>
