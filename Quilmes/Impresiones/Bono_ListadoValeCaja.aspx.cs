...
public partial class Impresiones_Bono_ListadoValeCaja : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Listado_ValedeCaja." + "PDF"));
