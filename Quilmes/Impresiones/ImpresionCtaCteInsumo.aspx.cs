...
public partial class Impresiones_ImpresionCtaCteInsumo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("ConInv", Request.QueryString["Inventario"]);
    ...
    public void Crearpdf()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=InsumoCtaCte." + "PDF"));
