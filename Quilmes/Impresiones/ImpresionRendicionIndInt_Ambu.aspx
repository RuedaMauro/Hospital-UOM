<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRendicionIndInt_Ambu.aspx.cs" Inherits="Impresiones_ImpresionRendicionIndInt" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
                ...
                <LocalReport ReportPath="Impresiones\ImpresionRendicionIndInt_Ambu.rdlc">
                    <DataSources>
            ...
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_PARTE_PRINT_BYID_SN_Ambu" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="NroParte" QueryStringField="Id" Type="Int64" />
                </SelectParameters>
