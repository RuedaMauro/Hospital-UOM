...
public partial class Impresiones_InternacionporApellidos : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("Fechas", Request.QueryString["FInicio"].ToString() + " AL " + Request.QueryString["FFin"].ToString());
