<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pato_Listado_Estadistica_nomenclador.aspx.cs" Inherits="Impresiones_Patologia_Pato_Listado_Estadistica_nomenclador" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Patologia\Pato_Listado_Estadistica_nomenclador.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Pato_Listado_Estadistica_nomenclador" 
