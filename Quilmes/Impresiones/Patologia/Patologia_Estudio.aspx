<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Patologia_Estudio.aspx.cs" Inherits="Impresiones_Patologia_Patologia_Estudio" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Patologia\Patologia_Estudio.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Pato_Imprimir" SelectCommandType="StoredProcedure">
            <SelectParameters>
