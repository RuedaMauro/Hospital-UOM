<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PAP_Estudio.aspx.cs" Inherits="Impresiones_Patologia_PAP_Estudio" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Patologia\PAP_Estudio.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_PAP_Imprimir" SelectCommandType="StoredProcedure">
            <SelectParameters>
