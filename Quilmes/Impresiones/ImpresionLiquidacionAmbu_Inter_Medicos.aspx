<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionLiquidacionAmbu_Inter_Medicos.aspx.cs" Inherits="Impresiones_ImpresionLiquidacionAmbu_Inter_Medicos" %>
    ...
    <div>
      <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionLiquidacionAmbu_Inter_Medicos.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_FACT_LIQUIDACION_AMBU_INT_MEDICOS" 
