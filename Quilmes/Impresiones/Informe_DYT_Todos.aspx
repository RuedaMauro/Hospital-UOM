<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Informe_DYT_Todos.aspx.cs" Inherits="Impresiones_Informe_DYT_Todos" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Informe_DYT_Todos.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_DYT_Impresion_Informe_Todo" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="TIPO_INFORME" QueryStringField="TIPO_INFORME" 
                    Type="Int32" />
