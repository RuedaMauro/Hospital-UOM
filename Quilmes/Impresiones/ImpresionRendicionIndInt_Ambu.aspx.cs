...
public partial class Impresiones_ImpresionRendicionIndInt : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=RendicionInternacionInd." + "PDF"));
