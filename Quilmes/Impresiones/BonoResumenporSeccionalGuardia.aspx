<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BonoResumenporSeccionalGuardia.aspx.cs" Inherits="Impresion_BonoResumenporSeccionalGuardia" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="fuentePracticas" runat="server" 
            ...
            SelectCommand="H2_Bono_Rendicion_Seccional_Guardia" 
            SelectCommandType="StoredProcedure" 
            onselecting="fuentePracticas_Selecting" 
            ProviderName="<%$ ConnectionStrings:HospitalConnectionString.ProviderName %>">
            <SelectParameters>
