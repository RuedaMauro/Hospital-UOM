<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRendicionIndInt_Medicos.aspx.cs" Inherits="Impresiones_ImpresionRendicionIndInt_Medicos" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
                ...
                <LocalReport ReportPath="Impresiones\ImpresionRendicionIndInt_Medicos.rdlc">
                    <DataSources>
            ...
            <asp:SqlDataSource ID="FuenteDatosCab" runat="server" 
                ...
                SelectCommand="H2_FACT_PARTE_PRINT_BYID_CAB_MEDICOS" 
            ...
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_PARTE_PRINT_BYID_MEDICOS" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="NroParte" QueryStringField="Id" Type="Int64" />
                </SelectParameters>
