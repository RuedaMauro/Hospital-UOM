<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporte_Turnos_OcupacionConsultorio.aspx.cs" Inherits="Impresiones_Reporte_Turnos_OcupacionConsultorio" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Reporte_Turnos_OcupacionConsultorio.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_INFORMES_TURNO_CONSULTORIOS_OCUPADOS" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="ConsultoriosIds" QueryStringField="Ids" 
                    Type="String" />
                <asp:QueryStringParameter Name="Dia" QueryStringField="Dia" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
