...
public partial class Impresiones_ImpresionLiquidacionDetallado_Medicos : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=LiquidacionDetallado_Medicos." + "PDF"));
