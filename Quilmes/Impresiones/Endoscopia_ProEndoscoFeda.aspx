<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Endoscopia_ProEndoscoFeda.aspx.cs" Inherits="Impresion_Endoscopia_ProEndoscoFeda" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Endoscopia_ProEndoscoFeda.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_QuirofanoProtocolo" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Endoscopia_ProEndoscoFeda_Listar_Imprimir" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
