<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiquidacionConsolidado_Medicos.aspx.cs" Inherits="Impresiones_LiquidacionConsolidado_Medicos" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <localreport reportpath="Impresiones\ImpresionLiquidacionConsolidado_Medicos.rdlc">
                <datasources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_FACT_LIQUIDACION_CONSOLIDADO_MEDICOS" 
