<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listados_Cantidad_De_pacientes_De_Rayos_Por_Seccional(aux).aspx.cs" Inherits="Impresiones_ReportesCalo_Listados_Cantidad_De_pacientes_De_Rayos_Por_Seccional_aux_" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesCalo\Listados_Cantidad_De_pacientes_De_Rayos_Por_Seccional(aux).rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listados_Cantidad_De_pacientes_De_Rayos_Por_Seccional(aux)" 
