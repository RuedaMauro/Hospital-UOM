<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listado_Cantidad_De_Practicas_De_Laboratorio_Por_Seccional(aux).aspx.cs" Inherits="Impresiones_ReportesCalo_Listado_Cantidad_De_Practicas_De_Laboratorio_Por_Seccional_aux_" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesCalo\Listado_Cantidad_De_Practicas_De_Laboratorio_Por_Seccional(aux).rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listado_Cantidad_De_Practicas_De_Laboratorio_Por_Seccional(aux)" 
