...
public partial class Impresiones_Impresion_Facturacion_NomencladorModulos : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=Modulos_Nomenclador." + "PDF"));
