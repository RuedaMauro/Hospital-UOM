...
public partial class Impresiones_ImpresionFactHonorarios : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[4] = new ReportParameter("Medico", Request.QueryString["MedicoId"]);
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=HonorariosMedicosFact." + "PDF"));
