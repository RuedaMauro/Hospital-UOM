<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Compras_RemitoProveedores.aspx.cs" Inherits="Impresiones_Compras_Compras_RemitoProveedores" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Compras\Compras_RemitoProveedores.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteCabecera" runat="server" 
            ...
            SelectCommand="H2_COMPRAS_REMITO_PRINT_CAB" SelectCommandType="StoredProcedure">
            <SelectParameters>
        ...
        <asp:SqlDataSource ID="FuenteDetalle" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_COMPRAS_REMITO_PRINT_DET" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="RemitoId" QueryStringField="Id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
