<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GuardiaAtencionPrint.aspx.cs" Inherits="Impresiones_GuardiaAtencionPrint" %>
...
<body>
    ...
    <div>
      <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
          ...
          <LocalReport ReportPath="Impresiones\GuardiaAtencion.rdlc" EnableExternalImages="true">
              <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteCab" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_GUARDIA_ATENCION_PRINT_CAB" 
        ...
        <asp:SqlDataSource ID="FuenteDet" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_GUARDIA_ATENCION_PRINT_DET" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="Id" QueryStringField="Id" Type="Int32" 
                    DefaultValue="" />
