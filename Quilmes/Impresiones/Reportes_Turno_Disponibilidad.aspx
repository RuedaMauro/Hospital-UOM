<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reportes_Turno_Disponibilidad.aspx.cs" Inherits="Impresiones_Reportes_Turno_Disponibilidad" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Reportes_Turno_Disponibilidad.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_INFORMES_TURNO_DISPONIBILIDAD" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter Name="EspecialidadId" QueryStringField="especialidad" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
