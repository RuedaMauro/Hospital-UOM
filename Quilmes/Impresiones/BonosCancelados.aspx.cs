...
public partial class Impresiones_BonosCancelados : System.Web.UI.Page
{
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=BonosCancelados." + "PDF"));
