<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Informe_DYT.aspx.cs" Inherits="Impresiones_Informe_DYT" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Informe_DYT.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_DYT_Impresion_Informe" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="TIPO_INFROME" QueryStringField="TIPO_INFROME" 
                    Type="Int32" />
