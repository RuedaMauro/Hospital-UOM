<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Insumos_Quirofano.aspx.cs" Inherits="Impresion_Insumos_Quirofano" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Insumos_Quirofano.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteInsumos" runat="server" 
            ...
            SelectCommand="H2_SELECT_INSUMOS_QUIROFANO_FOR_PRINT" 
