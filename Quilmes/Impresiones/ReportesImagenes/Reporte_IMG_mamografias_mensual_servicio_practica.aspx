<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporte_IMG_mamografias_mensual_servicio_practica.aspx.cs" Inherits="Impresiones_ReportesImagenes_mamografias_mensual_servicio_practica" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesImagenes\Reporte_IMG_mamografias_mensual_servicio_practica.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Reporte_IMG_Estudios_Mensual_Servicio_Practica" 
