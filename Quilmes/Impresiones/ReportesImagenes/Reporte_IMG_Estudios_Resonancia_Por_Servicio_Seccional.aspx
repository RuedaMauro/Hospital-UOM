<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Reporte_IMG_Estudios_Resonancia_Por_Servicio_Seccional.aspx.cs" Inherits="Impresiones_ReportesFarmacia_Reporte_IMG_Estudios_Resonancia_Por_Servicio_Seccional" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesImagenes\Reporte_IMG_Estudios_Resonancia_Por_Servicio_Seccional.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Reporte_IMG_Estudios_Resonancia_Por_Servicio_Seccional" 
