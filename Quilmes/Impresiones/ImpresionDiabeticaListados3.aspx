<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionDiabeticaListados3.aspx.cs" Inherits="Impresiones_ImpresionDiabeticaListados3" %>
...
<body>
    ...
    <div>
      <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionDiabeticaListados3.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="FuenteDiabetes" Name="Filtro3" />
           ...
           <asp:SqlDataSource ID="FuenteDiabetes" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_AtConsultorio_Diabetes_Listados_Filtro_3" 
            ...
            <SelectParameters>
                ...
                <asp:QueryStringParameter DefaultValue="" Name="desde" QueryStringField="desde" 
                    Type="DateTime" />
                <asp:QueryStringParameter DefaultValue="" Name="hasta" QueryStringField="hasta" 
                    Type="DateTime" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
