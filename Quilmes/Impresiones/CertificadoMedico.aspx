<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertificadoMedico.aspx.cs" Inherits="Impresion_CertificadoMedico" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\CertificadoMedico.rdlc">
                <DataSources>
