<%@ Page Language="C#" AutoEventWireup="true" CodeFile="At_Internados_PaseGuardiaUTI_Evo.aspx.cs" Inherits="Impresiones_At_Internados_PaseGuardiaUTI_Evo" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\At_Internados_PaseGuardiaUTI_Evo.rdlc">
                <DataSources>
    ...
    <asp:SqlDataSource ID="FuenteDatos" runat="server" 
        ...
        SelectCommand="H2_AT_INTERNADOS_LISTADO_PASE_GUARDIA_UTI_EVO" 
        SelectCommandType="StoredProcedure">
        <SelectParameters>
            <asp:QueryStringParameter DbType="Date" Name="Fecha" QueryStringField="Desde" />
        </SelectParameters>
    </asp:SqlDataSource>
