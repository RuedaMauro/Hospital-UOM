<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionMenu.aspx.cs" Inherits="Impresiones_Default" %>
...
<body>
    ...
    <div>
     <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
         ...
         <LocalReport ReportPath="Impresiones\impresionMenu.rdlc">
             <DataSources>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Internacion_Nutricion_Imprimir" 
