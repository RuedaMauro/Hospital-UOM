...
public partial class Impresiones_InternacionListarporFechas : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[6] = new ReportParameter("Fecha", Request.QueryString["FFin"].ToString());
