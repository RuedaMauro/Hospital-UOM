<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Quirofano_Cir_Suspendidas.aspx.cs" Inherits="Impresiones_Quirofano_Cir_Suspendidas" %>
...
<body>    
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Quirofano_Cir_Suspendidas.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Fuente_Suspendidas" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Quirofano_Suspendida_Impresion" 
