...
public partial class Impresiones_ReportesQuirofano_Reportes_Quirofano_Detalle_De_Cirugias_Reservadas_No_Cerradas : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[4] = new ReportParameter("error", "http://" + Request.Url.Host + ":" + Request.Url.Port + HttpContext.Current.Request.ApplicationPath + "/img/pcerror.png");
