...
public partial class Impresiones_LiquidacionConsolidado : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=LiquidacionConsolidado." + "PDF"));
