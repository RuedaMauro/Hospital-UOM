...
public partial class Impresiones_EntregasIM : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("NroEntrega", Request.QueryString["Nro"].ToString());
    ...
    public void PDF()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=EntregasIM." + "PDF"));
