<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRendicionAmbuOS.aspx.cs" Inherits="Impresiones_ImpresionRendicionAmbuOS" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
                    ...
                    <LocalReport ReportPath="Impresiones\ImpresionRendicionAmbuOS.rdlc">
                        <DataSources>
            ...
            SelectCommand="H2_FACT_AMBU_POR_OS" SelectCommandType="StoredProcedure">
                <SelectParameters>
