...
public partial class Impresiones_ImpresionLiquidacionAmbu_Inter : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=LiquidacionAmbuInter." + "PDF"));
