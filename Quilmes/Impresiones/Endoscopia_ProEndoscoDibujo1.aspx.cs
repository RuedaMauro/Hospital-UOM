...
public partial class Impresion_Endoscopia_ProEndoscoDibujo1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            parameters[2] = new ReportParameter("DibujoEndoscopia", "http://" + Request.Url.Host + ":" + Request.Url.Port + HttpContext.Current.Request.ApplicationPath + "/img/Endoscopia/Dibujo.bmp");          
