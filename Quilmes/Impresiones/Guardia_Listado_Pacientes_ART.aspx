<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Guardia_Listado_Pacientes_ART.aspx.cs" Inherits="Impresiones_Guardia_Listado_Pacientes_ART" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Guardia_Listado_Pacientes_ART.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            SelectCommand="H2_Guardia_Listado_Pacientes_ART" 
