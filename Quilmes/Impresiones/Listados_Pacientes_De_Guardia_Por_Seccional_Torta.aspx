<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listados_Pacientes_De_Guardia_Por_Seccional_Torta.aspx.cs" Inherits="Impresiones_Listados_Pacientes_De_Guardia_Por_Seccional_Torta" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listados_Pacientes_De_Guardia_Por_Seccional_Torta.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listados_Pacientes_De_Guardia_Grafico_Torta" 
