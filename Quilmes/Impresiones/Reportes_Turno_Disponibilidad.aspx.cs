...
public partial class Impresiones_Reportes_Turno_Disponibilidad : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=DisponibilidaddeTurnos_Detallado." + "PDF"));
