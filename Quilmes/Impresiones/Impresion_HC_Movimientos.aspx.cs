...
public partial class Impresiones_Impresion_HC_Movimientos : System.Web.UI.Page
{
    ...
    public void PDF(object sender, EventArgs e)
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=HC_Movimientos." + "PDF"));
