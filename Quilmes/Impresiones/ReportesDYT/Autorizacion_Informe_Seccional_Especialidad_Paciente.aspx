<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Autorizacion_Informe_Seccional_Especialidad_Paciente.aspx.cs" Inherits="Impresiones_ReportesDYT_Autorizacion_Informe_Seccional_Especialidad_Paciente" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\ReportesDYT\Autorizacion_Informe_Seccional_Especialidad_Paciente.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Autorizacion_Informe_Seccional_Especialidad_Paciente" 
