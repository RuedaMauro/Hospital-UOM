...
public partial class Impresion_BonoResumenporSeccionalNoGuardia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                parameters[6] = new ReportParameter("Seccional", "CONSULTORIOS Y PRACTICAS DE TODAS LAS SECCIONALES EXCEPTO QUILMES");
            }
            else
            {
