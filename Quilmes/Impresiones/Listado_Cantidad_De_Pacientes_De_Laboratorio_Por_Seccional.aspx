<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Listado_Cantidad_De_Pacientes_De_Laboratorio_Por_Seccional.aspx.cs" Inherits="Impresiones_Listado_Cantidad_De_Pacientes_De_Laboratorio_Por_Seccional" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\Listado_Cantidad_De_Pacientes_De_Laboratorio_Por_Seccional.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_Listado_Cantidad_De_Pacientes_Por_Laboratorio" 
