<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Internacion_FichaAdmision.aspx.cs" Inherits="Impresiones_Internacion_FichaAdmision" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Internacion_FichaAdmision.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_INTERNACION_FICHAADMISION_SN" 
