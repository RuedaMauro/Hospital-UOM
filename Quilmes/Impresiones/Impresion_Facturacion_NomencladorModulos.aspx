<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Impresion_Facturacion_NomencladorModulos.aspx.cs" Inherits="Impresiones_Impresion_Facturacion_NomencladorModulos" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Impresion_Facturacion_NomencladorModulos.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_NOMENCLADOR_MODULOS_PRINT" 
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="nomencladorId" QueryStringField="NomencladorId" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
