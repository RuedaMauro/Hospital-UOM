...
<head runat="server">
    ...
    <link href="../css/jquery-ui.css" rel="stylesheet" type="text/css" />
        ...
        <script type="text/javascript">
            parent.document.getElementById("DondeEstoy").innerHTML = "Consultorio > <strong>Atención Diabetología</strong> > <strong>Pacientes Existentes</strong> > <strong>Consultas Médicas</strong>";
</script> 
</head>
<body>
 <div class="clearfix">
    ...
    <div class="container" style="padding-top: 30px; height: 670px;">
        <div class="contenedor_1">
            <div class="contenedor_3" style="height:530px; padding-bottom:0px">
...
<a class="mano" id="btn_minimizarwebcam">Aceptar</a>
                ...
                <div id="Resultado" class="tabla" style="height: 290px; width: 98%; margin-left: 1%">
