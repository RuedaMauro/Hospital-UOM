<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Impresion_Facturacion_NomencladorValores.aspx.cs" Inherits="Impresiones_Impresion_Facturacion_NomencladorValores" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Impresion_Facturacion_NomencladorValores.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_NOMENCLADOR_VALORES_PRINT" 
