<%@ Page Language="C#" AutoEventWireup="true" CodeFile="INFORMES_PRACTICAS_POR_MEDICO_DETALLADO_POR_SECCIONAL.aspx.cs" Inherits="Impresiones_INFORMES_PRACTICAS_POR_MEDICO_DETALLADO_POR_SECCIONAL" %>
...
<body>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\INFORMES_PRACTICAS_POR_MEDICO_DETALLADO_POR_SECCIONAL.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ...
            SelectCommand="H2_INFORMES_PRACTICAS_POR_MEDICO_DETALLADO" 
