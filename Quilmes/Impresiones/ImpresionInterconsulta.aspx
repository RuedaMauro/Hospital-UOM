<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionInterconsulta.aspx.cs" Inherits="Impresiones_ImpresionInterconsulta" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\ImpresionInterconsulta.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_AT_INTERNADOS_PRINT_INTERCONSULTA" 
