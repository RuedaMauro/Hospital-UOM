<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Indicadores.aspx.cs" Inherits="Impresiones_IndicadoresDeSeguridadSocial_Indicadores" %>
  ...
  <asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\IndicadoresDeSeguridadSocial\Indicadores.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="Datos" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_Imprimir_Indicadores" 
