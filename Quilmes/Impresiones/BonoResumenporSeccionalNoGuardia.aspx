<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BonoResumenporSeccionalNoGuardia.aspx.cs" Inherits="Impresion_BonoResumenporSeccionalNoGuardia" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="fuentePracticas" runat="server" 
            ...
            SelectCommand="H2_Bono_Rendicion_Seccional_NOGUARDIA" 
