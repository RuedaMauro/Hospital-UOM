<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RemitoProveedores.aspx.cs" Inherits="Impresiones_RemitoProveedores" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" 
            ...
            <LocalReport ReportPath="Impresiones\IMPRIMIR_GENERAL.rdlc" 
        ...
        <asp:SqlDataSource ID="FuenteCab" runat="server" 
            ...
            SelectCommand="H2_LIST_REMITO_CAB_BY_REMID" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="Remito_Id" QueryStringField="Id" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="FuenteDet" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_LIST_REMITO_DET_BY_REMID_PRINT" 
