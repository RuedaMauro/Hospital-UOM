<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bono_CajaVale.aspx.cs" Inherits="Impresiones_Bono_CajaVale" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
            ...
            <LocalReport ReportPath="Impresiones\Bono_CajaVale.rdlc">
                <DataSources>
        ...
        <asp:SqlDataSource ID="FuenteDatos" runat="server" 
            ...
            SelectCommand="H2_BONO_CAJAVALE_PRINT" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter Name="BonoId" QueryStringField="NroBono" 
                    Type="Int64" />
            </SelectParameters>
        </asp:SqlDataSource>
