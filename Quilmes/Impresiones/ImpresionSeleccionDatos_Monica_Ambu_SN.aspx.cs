...
public partial class Impresiones_ImpresionSeleccionDatos_Monica_Ambu_SN : System.Web.UI.Page
{
    ...
    public void pdf_Click()
    {
        ...
        HttpContext.Current.Response.AddHeader("content-disposition", ("inline; filename=ImpresionAmbulatorio_Monica." + "PDF"));
