<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionRendicionIndInt.aspx.cs" Inherits="Impresiones_ImpresionRendicionIndInt" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" 
                ...
                <LocalReport ReportPath="Impresiones\ImpresionRendicionIndInt.rdlc">
                    <DataSources>
            ...
            ConnectionString="<%$ ConnectionStrings:HospitalConnectionString %>" 
            SelectCommand="H2_FACT_PARTE_PRINT_BYID_SN" 
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:QueryStringParameter Name="NroParte" QueryStringField="Id" Type="Int64" />
                </SelectParameters>
