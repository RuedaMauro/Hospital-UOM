<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LiquidacionMensual_Medicos.aspx.cs" Inherits="Facturacion_Cap_LiquidacionMensual_Medicos" %>
...
<script>
    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Listado de Liquidación Mensual Médicos</strong>";
</script>
...
<div class="pull-left" style="margin-left: 20px;"><a id="btnBuscar" class="btn"><i class="icon-search"></i>&nbsp;Buscar</a></div>
    ...
    <script src="../js/Hospitales/Facturacion_Cap/LiquidacionMensual_Medicos.js" type="text/javascript"></script>
</html>
