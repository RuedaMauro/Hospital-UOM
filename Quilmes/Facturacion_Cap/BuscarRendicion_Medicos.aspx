<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarRendicion_Medicos.aspx.cs" Inherits="Facturacion_Cap_BuscarRendicion_Medicos" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      <span>Buscar Rendiciones Honorario Médicos</span></div>
      <form id="frm_Main" name="frm_Main">
  
 <div class="contenedor_4 pagination-centered" style="height:200px; margin-top:5px; margin-left:10px;">
         <div class="row" style="margin-left:5px;">
          ...
          <div class="row" style="margin-left:5px;">
              <div id="controlcbo_Medicos" class="span5">
                    <label for="cbo_Medicos" style="display:inline; margin-top:10px;">Médicos: </label>
                    <select id="cbo_Medicos" name="cbo_Medicos" class="input-large" style="margin-top:10px;">
          ...
          <div class="row" style="margin-left:5px;">
                 <div id="controlcbo_Centro" class="span5">
                    ...
                    <select id="cbo_Centro" name="cbo_Centro" class="input-large" style="margin-top:10px; width:250px;">
...
<script src="../js/Hospitales/Facturacion_Cap/BuscarRendicion_Medicos.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Buscar Rendiciones Honorario Médicos</strong>";
