                    ...
                    <div class="">
                      <div class="tabbable" style="margin-left:10px;">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab1" id="tab1_" data-toggle="tab">Datos Convenio</a></li>
                            <li><a href="#tab2" id="tab2_" data-toggle="tab">Datos Factura</a></li>
                        </ul>
                      <div class="tab-content" style="height:380px;">
         

                <div class="tab-pane active" id="tab1" style="height:370px;">
                    <form id="frm_Main">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                                ...
                                <div class="span3">
                                    <div id="controltxtFechaInicio" class="control-group" style="width:316px">
                                    <label for="txtFechaInicio" style="display:inline; margin-left:58px">Fecha Inicio: </label>
                                        <input id="txtFechaInicio" name="txtFechaInicio" type="text" class="input-small">
                                    </div>
                                </div>
                                <div class="span3">
                                    <div id="controltxtFechaFin" class="control-group">
                                    <label for="txtFechaFin" style="display:inline; margin-left:40px">Fecha Fin: </label>
                 ...
                 <div class="tab-pane" id="tab2" style="height:370px;">
                    <form id="frm_Factura">
                        <div class="minicontenedor100">
                        <div class="row">
                            <div class="span10">
                                <div id="Div2" class="control-group">
                                <label for="txtConvenios" style="display:inline;">Razon Social: </label>
                                    <input id="txtRazonSocial" name="txtRazonSocial" type="text" class="input-xlarge" maxlength="38"/>
                                </div>
                            </div>
                         </div>   
                         <div class="row">
                                <div class="span4">
                                    <div id="Div3" class="control-group">
                                     <label for="txtDireccion_Fact" style="display:inline;">Dirección: </label>
                                        <input id="txtDireccion_Fact" name="txtDireccion_Fact" type="text" class="input-large" maxlength="40"/>
                                    </div>
                                </div>
                                <div class="span3">
                                    <div id="Div4" class="control-group">
                                    <label for="txtCUIT_Fact" style="display:inline;">CUIT: </label>
                                        <input id="txtCUIT_Fact" name="txtCUIT_Fact" type="text" class="input-small" maxlength="11"/>
                                    </div>
                                </div>
                        </div>
                        </div>
...
<script src="../js/jquery.maskedinput-1.3.js" type="text/javascript"></script>
    <script src="../js/Hospitales/Facturacion/AltaNomencladores.js" type="text/javascript"></script>
