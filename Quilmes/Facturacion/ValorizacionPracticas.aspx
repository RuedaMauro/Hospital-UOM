...
<h3>Valorización y Asignación de Prácticas</h3>
...
<br/>    
      ...
      <div id="my-tab-content" class="tab-content" style="height:121px;">
...
V. Bono <input type="text" id="txt_Vbono" name="txt_Vbono" class="span2" value="0.00"/>
</div>
<div id="controltxt_Vaa" class="control-group" style="display:inline;">
U Sanatorial <input type="text" id="txt_Vaa" name="txt_Vaa" class="span2" value="0.00"/>
</div>
<div id="controltxt_Vaci" class="control-group" style="display:inline; display:none;">
 <input type="text" id="txt_Vaci" name="txt_Vaci" class="span2" value="0.00"/>
</div>
<div id="controltxt_VNN" class="control-group" style="display:inline;">
V.Fact <input type="text" id="txt_VNN" name="txt_VNN" class="span2" title="Valor Facturado" rel="tooltip" value="0.00"/>
</div>
<div id="controltxt_VG" class="control-group" style="display:inline; display:none;">
V. Gastos <input type="text" id="txt_VG" name="txt_VG" class="span2" value="0.00"/>
</div>
<div id="controltxt_Honorario" class="control-group" style="display:inline;">
Honorarios <input type="text" id="txt_Honorario" name="txt_Honorario" class="span2" value="0.00"/>
</div>
</div>
</form>
      <div class="pie_gris" id="pie">
        <a id="btn_Actualizar" class="btn btn-info pull-right">Actualizar</a> 
    ...
    <script src="../js/Hospitales/Facturacion/ValorizacionPracticas.js" type="text/javascript"></script>
    <script src="../js/jQuery-validate.js" type="text/javascript"></script>
    <script src="../js/jquery.fancybox-1.3.4.pack.js" type="text/javascript"></script>
    <link href="../css/jquery.fancybox-1.3.4.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Valorización y Asignación de Prácticas</strong>";    
    </script>
</body>
</html>
