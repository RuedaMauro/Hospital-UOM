   ...
   <div class="contenedor_3" style="height:530px;"> <div class="titulo_seccion" id="titulo_bono">
      ...
      <form id="frm_Main" name="frm_Main">
          <div style="padding:0px 15px 0px 15px; height:100px;">
            <div class="row" style="margin-left:5px;">
              ...
              <div id="controlcbo_Centro" class="span5">
                    ...
                    <select id="cbo_Centro" name="cbo_Centro" class="input-xlarge" style="margin-top:10px;">
                 
                    </select>
              </div>

              <div id="controlAmbu" class="span6">
                      <div id="controlAmbulatorio" class="span2" style="display:inline;">
                            <label for="Ambulatorio" style="display:inline; margin-top:10px;">Ambulatorio</label>
                            <input type="radio" name="opc" id="Ambulatorio" />
                      </div>
                       <div id="controlInternacion" class="span2" style="display:inline;">
                            <label for="Internacion" style="display:inline; margin-top:10px;">Internacion</label>
                            <input type="radio" name="opc" id="Internacion" checked />
                      </div>
              </div>
            </div>
        
        <div class="contenedor_4 pagination-centered" style="height:60px; display:none;">
        ...
        <div style="padding:15px 15px 0px 15px;">
            ...
            <div class="clearfix"></div>
            <div id="TablaPartes_div" class="tabla" style="height:220px;width:100%; margin-top:-80px;">
        ...
        <div class="minicontenedor50 pagination-centered" id="Seccionales" style="width:400px; display:none;">
        ...
        <div class="minicontenedor50 pagination-centered" id="Instituciones" style="width:800px;">
                        <div class="check_todos"><label class="checkbox">
                                <input onchange="toggle_checks_Ins(this)" id="cbo_Todos_Instituciones" value="0" type="checkbox">Obras Sociales
                            </label></div>
                            <div class="filtro_datos" style="width:98%; height:90px">                                                        
                                <div id="FiltroInstituciones" style="float: left; width:50%;">
                                
                                </div>
                                <div id="FiltroInstituciones2" style="float: right; width:50%;">
...
<button id = "btnGenerarNueva" class="btn btn-info"><i class="icon-ok-circle icon-white"></i>&nbsp;Emitir Factura</button>
<button id = "btnPrint" class="btn btn-info"><i class=" icon-print icon-white"></i>&nbsp;Imprimir</button>
  ...
  <div class="modal-body" style="margin-left:10px; margin-right:10px;">
   ...
   <div id="ModalNueva" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="ModalNuevaLabel" aria-hidden="true" style="width:600px;height:500px;">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="ModalNuevaLabel">Emitir Factura</h3>
  </div>
  <div class="modal-body" style="margin-left:10px; margin-right:10px;">
            <div class="row">
                <div id="controlcbo_Instituciones" class="span6">
                    <label for="cbo_Instituciones" style="display:inline; margin-top:10px;">Obra Social: </label>
                    <select id="cbo_Instituciones" name="cbo_Instituciones" class="input-xlarge" style="margin-top:10px;">
                 
                    </select>
                </div>
            </div>
            <div class="row">
                  <div id="controltxtValor" class="span4">
                    <label for="txtValor" style="display:inline; margin-top:10px;">Importe $</label>
                    <input type="text" name="txtValor" id="txtValor" class="input-mini" style="width:80px;" />
                  </div>
            </div>
             <textarea id="txtComentario" style="width:550px; height:180px;" placeholder="Escriba aquí alguna observación..."></textarea>
    </div>
  </div>
...
<script src="../js/jquery-ui-1.9.2.custom.js" type="text/javascript"></script>
    ...
    <script src="../js/Hospitales/Facturacion/Facturacion.js" type="text/javascript"></script>
