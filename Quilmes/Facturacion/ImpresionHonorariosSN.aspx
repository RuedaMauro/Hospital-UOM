<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImpresionHonorariosSN.aspx.cs" Inherits="Facturacion_ImpresionHonorariosSN" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:490px;"> <div class="titulo_seccion" id="titulo_bono" style="display:none;">
      <span>Resumen de Honorarios (OSPECON)</span></div>
...
<script src="../js/Hospitales/Facturacion/RendicionHonorarioSN.js" type="text/javascript"></script>
 

<!--Barra sup--> 
<script type="text/javascript">

    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Resumen de Honorarios (OSPECON)</strong>";
