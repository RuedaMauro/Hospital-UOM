<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RendicionInternacionSN.aspx.cs" Inherits="Facturacion_RendicionInternacionSN" %>
...
<div class="container" style="padding-top:30px;">
  <div class="contenedor_1">
   <div class="contenedor_3" style="height:490px;"> <div class="titulo_seccion" id="titulo_bono" style="display:none;">
      <span>Resumen de Internación</span></div>
...
<script src="../js/Hospitales/Facturacion/RendicionInternacionSN.js" type="text/javascript"></script>
 

<!--Barra sup--> 
<script type="text/javascript">

    parent.document.getElementById("DondeEstoy").innerHTML = "Facturación > <strong>Resumen de Internación</strong>";
