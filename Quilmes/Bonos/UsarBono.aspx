<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UsarBono.aspx.cs" Inherits="Bonos_CancelarBono" %>
...
<body>
    ...
    <script>
        parent.document.getElementById("DondeEstoy").innerHTML = "Bonos > <strong>Usar Bono</strong>";
    </script>
                ...
                <div class="resumen_datos" style="height:130px;">
                    ...
                    <div class="datos_paciente" style="width:560px;">
                        <div class="datos_resumen_paciente">
                            ...
                            <br />
                            <div>
                            <a id="btn_Usar" class="btn btn-info">Usar Bono</a>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix">
...
<script src="../js/Hospitales/Bonos/UsarBonos.js" type="text/javascript"></script>