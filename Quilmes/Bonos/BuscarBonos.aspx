<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuscarBonos.aspx.cs" Inherits="Bonos_BuscarBonos" %>
...
<body>
    ...
    <script type="text/javascript">
        parent.document.getElementById("DondeEstoy").innerHTML = "Bonos > <strong>Buscar Bonos</strong>";
                ...
                <div class="contenedor_3" style="height:490px">
                    ...
                    <div class="pie_gris">
                        <div class="pull-right">
                            <a id="btnPrint" class="btn btn-info"><i class=" icon-print"></i>&nbsp;Imprimir Cancelados</a>
...
<script src="../js/Hospitales/Bonos/BuscarBonos.js" type="text/javascript"></script>
</body>
</html>
