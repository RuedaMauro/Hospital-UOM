<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HallazgosNoNeoplasicos.aspx.cs" Inherits="AnatomiaPatologicaTrue_HallazgosNoNeoplasicos" %>
...
<div class="container" style="padding-top:30px; width:1000px;">
  <div class="contenedor_1" style="width:1000px;">
   <div class="contenedor_3" style="height:50%;width:80%; margin-left:10%"> <div class="titulo_seccion" id="titulo">
      <span>Hallazgos no Neoplásicos</span></div>
        <!--Tabla de estudios-->
...
<script src="../js/Hospitales/AnatomiaPatologicaTrue/HallazgosNoNeoplasicos.js" type="text/javascript"></script>
