<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Diagnosticos.aspx.cs" Inherits="AnatomiaPatologicaTrue_Diagnosticos" %>
...
<div class="container" style="padding-top:30px; width:1000px;">
  <div class="contenedor_1" style="width:1000px;">
   <div class="contenedor_3" style="height:50%;width:80%; margin-left:10%"> <div class="titulo_seccion" id="titulo">
      <span>Diagnósticos</span><div style="text-align:center"><input id="diagnosticoSearch" type="text" style="text-align:center" maxlength="8"/></div></div>
        <!--Tabla de estudios-->
...
<script src="../js/Hospitales/AnatomiaPatologicaTrue/Diagnosticos.js" type="text/javascript"></script>
