<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraLabo.aspx.cs" Inherits="Turnera_TurneraLabo" %>
...
<div class="Pie">
    <div class="Media">
<%--<iframe src="http://www.youtube.com/embed/MPj_uBA2Tps?rel=0&wmode=opaque&autoplay=1&loop=1" frameborder="0" allowfullscreen></iframe>--%>
</div>
...
<script src="../js/Hospitales/Llamador/TurneraLabojs.js" type="text/javascript"></script>
...
//    });
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraLabo.aspx';
            }
        }
    }
