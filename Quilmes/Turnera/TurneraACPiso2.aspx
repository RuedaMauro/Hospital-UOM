<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraACPiso2.aspx.cs" Inherits="Turnera_TurneraPiso2AC" %>
...
<script src="../js/Hospitales/Llamador/TurneraPiso2.js" type="text/javascript"></script>
...
//    });
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraLaboACPiso2.aspx';
            }
        }
    }
