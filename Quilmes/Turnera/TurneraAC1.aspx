<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TurneraAC1.aspx.cs" Inherits="Turnera_TurneraAC1" %>
...
<script src="../js/Hospitales/Llamador/TurneraAC1.js" type="text/javascript"></script>
...
//    });
    ...
    function Refrescar_Pantalla() {
        ...
        if (hh >= 22 && hh < 23) {
            if (mm >= 00 && mm <= 59) {
                window.location.href = 'http://10.10.8.71/Turnera/TurneraAC1.aspx';
            }
        }
    }
