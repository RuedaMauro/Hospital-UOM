<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IMG_Parte_Diario.aspx.cs" Inherits="Imagenes_Imagenes_Parte_Diario" %>
...
<script>
    parent.document.getElementById("DondeEstoy").innerHTML = "Turnos (IMG)> <strong>Parte Diario</strong>";
</script>
...
<div class="row" style="margin-left:15px; display:none">
    ...
    <script src="../js/Hospitales/Imagenes/IMG_Parte_Diario.js" type="text/javascript"></script>
</body>
</html>
